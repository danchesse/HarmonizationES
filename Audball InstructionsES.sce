scenario = "Auditory Oddball Instructions (Spanish Version)";
...
wavefile { filename = "AODinstruct1ES.m4a"; } adi1;
sound {
    wavefile adi1;
    attenuation = 0.2;
} aod1Instruction;
...
wavefile { filename = "AODinstruct2ES.m4a"; } adi2;
sound {
    wavefile adi2;
    attenuation = 0.2;
} aod2Instruction;

wavefile { filename = "AODinstruct3ES.m4a"; } adi3;
sound {
    wavefile adi3;
    attenuation = 0.2;
} aod3Instruction;

wavefile { filename = "AODinstruct4ES.m4a"; } adi4;
sound {
    wavefile adi4;
    attenuation = 0.2;
} aod4Instruction;

wavefile { filename = "AODinstruct5ES.m4a"; } adi5;
sound {
    wavefile adi5;
    attenuation = 0.2;
} aod5Instruction;
